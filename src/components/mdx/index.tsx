...
export const MDXComponents = {
  ...
  p: (props: ParagraphProps) => <p className="my-5 text-base leading-7 text-secondary-foreground" {...props} />,

  ul: (props: ListProps) => <ul className="mb-5 list-disc pl-5 text-base leading-7 text-secondary-foreground" {...props} />,
  ol: (props: OrderedListProps) => <ol className="mb-5 list-decimal pl-5 text-base leading-7 text-secondary-foreground" {...props} />,
